public class DrivingLicense6{
    ...
    DrivingLicense6(String firstName, String lastName, String address, String city, String driverLicenseNumber, int yearOfIssue, String category){
    ...
    void setFirstName(String newFirstName){
        String cap = newFirstName.substring(0, 1).toUpperCase() + newFirstName.substring(1);
        this.firstName = cap;
    }
